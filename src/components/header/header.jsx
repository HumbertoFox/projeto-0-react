    ...
    return (
        <MenuHeader>
            ...
            <nav>
                <ul>
                    <li>
                        <Link to={"/CadastroDoacao"} title="Cadastrar Doação" name="cadastro_doacao" className={navMenuLi == "Cadastrar Doação" ? "active" : ""} onClick={() => handlesMenuLiClick("Cadastrar Doação")}>
                            <FontAwesomeIcon icon="fa-solid fa-pen-to-square" />
                            <span>Cadastrar Doação</span>
                        </Link>
                    </li>
                    <LiSvgRotation>
                        <Link to={"/CadastroDoador"} title="Cadastrar Doador" name="cadastro_doador" className={navMenuLi == "Cadastrar Doador" ? "active" : ""} onClick={() => handlesMenuLiClick("Cadastrar Doador")}>
                            <FontAwesomeIcon icon="fa-solid fa-user-plus" />
                            <span>Cadastrar Doador</span>
                        </Link>
                    </LiSvgRotation>
                    <li>
                        <Link to={"/EditaDoacao"} title="Editar Doação" name="editar_doacao" className={navMenuLi == "Editar Doação" ? "active" : ""} onClick={() => handlesMenuLiClick("Editar Doação")}>
                            <FontAwesomeIcon icon="fa-regular fa-pen-to-square" />
                            <span>Editar Doação</span>
                        </Link>
                    </li>
                    <LiSvgRotation>
                        <Link to={"/EditaDoador"} title="Editar Doador" name="editar_doador" className={navMenuLi == "Editar Doador" ? "active" : ""} onClick={() => handlesMenuLiClick("Editar Doador")}>
                            <FontAwesomeIcon icon="fa-solid fa-user-pen" />
                            <span>Editar Doador</span>
                        </Link>
                    </LiSvgRotation>
                    <li>
                        <Link to={"/AgendarColeta"} title="Agendar Coleta" name="agendar_coleta" className={navMenuLi == "Agendar Coleta" ? "active" : ""} onClick={() => handlesMenuLiClick("Agendar Coleta")}>
                            <FontAwesomeIcon icon="fa-regular fa-calendar-plus" />
                            <span>Agendar Coleta</span>
                        </Link>
                    </li>
                    <li>
                        <Link to={"/ConfirmColeta"} title="Confirmar Coleta" name="confirmar_coleta" className={navMenuLi == "Confirmar Coleta" ? "active" : ""} onClick={() => handlesMenuLiClick("Confirmar Coleta")}>
                            <FontAwesomeIcon icon="fa-regular fa-calendar-check" />
                            <span>Confirmar Coleta</span>
                        </Link>
                    </li>
                    <LiSvgRotation>
                        <Link to={"/Relatorio"} title="Relatório" name="gerar_relatorio" className={navMenuLi == "Relatório" ? "active" : ""} onClick={() => handlesMenuLiClick("Relatório")}>
                            <FontAwesomeIcon icon="fa-solid fa-file-circle-check" />
                            <span>Relatório</span>
                        </Link>
                    </LiSvgRotation>
                    <li>
                        <Link to={"/Agenda"} title="Agenda" name="Agenda" className={navMenuLi == "Agenda" ? "active" : ""} onClick={() => handlesMenuLiClick("Agenda")}>
